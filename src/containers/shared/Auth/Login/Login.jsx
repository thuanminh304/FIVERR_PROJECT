      ...
      <div className="signIn__content">
        <form className>
          <div className="sign-in__form">
            ...
            <div className="form__social-signing">
              <button
                type="button"
                className="social-signing-button facebook-signing-button"
              >
                <span
              ...
              <button
                type="button"
                className="social-signing-button google-signing-button"
              >
                <span
                  className="social-icon"
                  style={{ width: 18, height: 18 }}
              ...
              <button
                type="button"
                className="social-signing-button apple-signing-button"
              >
                <span
                  className="social-icon"
                  style={{ width: 18, height: 18 }}
