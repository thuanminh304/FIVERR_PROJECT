...
import { actLogoutUser } from "containers/admin/nguoi-dung/module/action";
        ...
        <div id="header__content-fixed">
          ...
          <div className="header__nav-fixed">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropmenu-user" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" style={{color:'green'}} onClick={handleLogoutUser} href="#">
                  Logout
                </a>
              </div>
            </div>
