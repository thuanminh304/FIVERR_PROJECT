...
const JobManagementReducer = (state = initialState, { type, payload }) => {
    switch (type) {
        ...
        case GET_ALL_JOB_SUCC: {
            return {...state,loadding: false, dataSatictis: payload, isError: false};
        };
